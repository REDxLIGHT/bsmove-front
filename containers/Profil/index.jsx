    ...
    <div className={styles.profil_navigation_row_container}>
      ...
      <div className={styles.profil_navigation_row_categories}>
        <div className={styles.profil_navigation_row_category_container}>
          <div className={styles.profil_navigation_row_category_title}>{messages.settings.title}</div>
          <VerticalTabs tabs={profilTabs} handleTabChange={handleTabChange} active={activeTab} />
        </div>
        <div className={styles.profil_navigation_row_category_container}>
          <div className={styles.profil_navigation_row_category_title}>{messages.mySpace.title}</div>
          <VerticalTabs tabs={mySpaceTabs} handleTabChange={handleTabChange} active={activeTab} />
        </div>
